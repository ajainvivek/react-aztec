...
class DatePicker extends React.Component {
  ...
  render() {
    ...
    return <DATEPICKER {...props.attributes} errorText={this.state.errorText} onChange={this.onChange} onFocus={this.onFocus} onShow={this.onShow} onDismiss={this.onDismiss} />;
  }
}
